...
import { DATE_ISO_STRING_PATTERN, DATE_ISO_STRING_REGEXP } from './parseDateIsoString.js';
import { YEAR_MONTH_DAY_DATE_PATTERN, YEAR_MONTH_DAY_DATE_REGEXP } from './parseDateUsingFormat.js';

import { EMAIL_REGEXP } from './types/isValidEmail.js';
import { URL_REGEXP } from './types/isValidUrl.js';
import { RELATIVE_URL_REGEXP } from './types/isValidRelativeUrl.js';
...
export const defaultDateType = date();
