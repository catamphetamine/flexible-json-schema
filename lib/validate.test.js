...
describe('validate', function() {
  ...
  it('should allow empty arrays when `allowEmptyArrays` is `false` (default) `nonEmpty` is `false`', function() {
    const validate = schemaValidation({
      a: {
        arrayOf: 'string',
        description: 'Strings',
  ...
  it('should allow empty arrays when `allowEmptyArrays` is `false` (default) `allowEmpty` is `true`', function() {
    const validate = schemaValidation({
      a: {
        arrayOf: 'string',
        description: 'Strings',
  ...
  it('should allow empty arrays when `allowEmptyArrays` is `true` and `allowEmpty` is `true`', function() {
    const validate = schemaValidation({
      a: {
        arrayOf: 'string',
        description: 'Strings',
  ...
  it('should support `null` type', function() {
    ...
    validate({ a: undefined });
    validate({});
    expect(() => validate({ a: '' })).to.throw('must be null');
    expect(() => validate({ a: 'a' })).to.throw('must be null');
  });
  ...
  it('should validate empty object', function() {
    ...
    validate({})
    expect(() => validate({ a: 'b' })).to.throw('unknown');
  })

  it('should validate empty object empty schema', function() {
    const schema = {
      schema: {
        a: {
          type: 'string',
    ...
    expect(() => schemaValidation(schema)).to.throw('Expected an empty object {} schema');
  })
