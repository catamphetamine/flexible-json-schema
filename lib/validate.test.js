...
describe('validate', function() {
  ...
  it('should allow empty strings when `allowEmptyStrings` is `true`', function() {
    const validate = schemaValidation({
      a: {
        type: 'string',
        description: 'String',
  ...
  it('should validate with schema references (object)', function() {
    const schemas = {
      object: {
        a: {
          type: 'string',
  ...
  it('should validate with schema references (value)', function() {
    const schemas = {
      object: {
        a: {
          type: 'string',
